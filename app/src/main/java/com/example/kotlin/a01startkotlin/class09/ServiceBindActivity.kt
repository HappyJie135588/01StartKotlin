...
import com.example.kotlin.a01startkotlin.class09.service.BindService
...
class ServiceBindActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Bind.tv_bind = findViewById(R.id.tv_bind)
        btn_start_bind.setOnClickListener {
            val intentBind = intentFor<BindService>(Pair("request_content", et_request.text.toString()))
