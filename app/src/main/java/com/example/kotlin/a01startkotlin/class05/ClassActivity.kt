...
import com.example.kotlin.a01startkotlin.animal.Animal
import com.example.kotlin.a01startkotlin.animal.AnimalDefault
import com.example.kotlin.a01startkotlin.animal.AnimalMain
import com.example.kotlin.a01startkotlin.animal.AnimalSeparate
...
class ClassActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_class_main.setOnClickListener {
            ...
            when (count % 2) {
                0 -> {
                    ...
                    var animal = AnimalMain(this, animalName, animalSex)
                }
            }
        ...
        btn_class_seperate.setOnClickListener {
            ...
            when (count % 2) {
                0 -> {
                    var animal = AnimalSeparate(this, animalName)
                }
                else -> {
                    var animal = AnimalSeparate(this, animalName, animalSex)
                }
            }
        }
        ...
        btn_class_default.setOnClickListener {
            ...
            when (count % 2) {
                0 -> {
                    ...
                    var animal = AnimalDefault(this, animalName, animalSex)
                }
            }
        }
