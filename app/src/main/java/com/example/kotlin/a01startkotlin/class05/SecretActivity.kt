...
import com.example.kotlin.a01startkotlin.forest.*
...
class SecretActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_class_enum.setOnClickListener {
            if (count % 2 == 0) {
                ...
                tv_class_secret.text = when (count++ % 4) {
                    ...
                    SeasonType.SPRING.ordinal -> SeasonName.SPRING.seasonName
                    SeasonType.SUMMER.ordinal -> SeasonName.SUMMER.seasonName
                    SeasonType.AUTUMN.ordinal -> SeasonName.AUTUMN.seasonName
                    SeasonType.WINTER.ordinal -> SeasonName.WINTER.seasonName
                    else -> "未知"
        ...
        btn_class_data.setOnClickListener {
            ...
            var result = if (lotus.equals(lotus2)) "相等" else "不等"
